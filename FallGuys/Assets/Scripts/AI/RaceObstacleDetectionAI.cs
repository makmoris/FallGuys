...
public class RaceObstacleDetectionAI : MonoBehaviour
{
	...
	[SerializeField] private Transform leftAngle2;
	[SerializeField] private Transform rightAngle2;
    ...
    public void CheckObstacles()
	{
		...
		Vector3 DirAngleLeft2 = -leftAngle2.forward;
		Vector3 DirAngleRight2 = -rightAngle2.forward;
		...
		else if (Physics.Raycast(PosLeft, DirCenter, out hit, raycastLength, obstacleLayerMask))
		{                   // Left
			Obstacles = "Left_2";
			ObstacleDistance = hit.distance;
		...
		else if (Physics.Raycast(PosRight, DirCenter, out hit, raycastLength, obstacleLayerMask))
		{               // Right
			Obstacles = "Right_2";
			ObstacleDistance = hit.distance;
		...
		if (Physics.Raycast(PosRight, -DirAngleRight, out hit, raycastLength, obstacleLayerMask))
		{       // Right angle
			Obstacles = "Right_3";
			ObstacleDistance = hit.distance;
		...
		if (Physics.Raycast(PosLeft, -DirAngleLeft, out hit, raycastLength, obstacleLayerMask))
		{           // Left angle
			Obstacles = "Left_3";
			ObstacleDistance = hit.distance;
		...
		//if (Physics.Raycast(PosRight, -DirAngleRight2, out hit, raycastLength, obstacleLayerMask))
		//{       // Right angle
		//	Obstacles = "Right_3";
		//	ObstacleDistance = hit.distance;
		...
		//if (Physics.Raycast(PosLeft, -DirAngleLeft2, out hit, raycastLength, obstacleLayerMask))
		//{           // Left angle
		//	Obstacles = "Left_3";
		//	ObstacleDistance = hit.distance;
		...
		Debug.DrawLine(PosLeft, PosLeft + DirCenter * raycastLength, Color.red);
		Debug.DrawLine(PosRight, PosRight + DirCenter * raycastLength, Color.red);

		Debug.DrawLine(PosLeft, PosLeft - DirAngleLeft * raycastLength, Color.blue);
		Debug.DrawLine(PosRight, PosRight - DirAngleRight * raycastLength, Color.blue);

		Debug.DrawLine(PosLeft, PosLeft - DirAngleLeft2 * raycastLength, Color.green);
		Debug.DrawLine(PosRight, PosRight - DirAngleRight2 * raycastLength, Color.green);
	}
